...
public:
	...
	std::string value_to_string(int index, float value);
	...
	float m_base_upgrade_projectile_speed = 0.2f;
	float m_base_upgrade_fire_range		  = 20.0f;
	float m_base_upgrade_fire_rate		  = 0.1f;
	int m_base_upgrade_health			  = 1.0f;
